    ...
    methods: {
        ...
        startRingtone() {
            ...
            try {
                ...
                // create a fresh, short-lived context just for the ring
        ...
        stopRingtone() {
            ...
            // fully release the audio context so nothing holds the audio device
            // while a call is active (this frees the mic on desktop).
            if(this.ringtoneCtx){
